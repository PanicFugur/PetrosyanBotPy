rabotaetliresplist = ["Нет, не работает.",
                      "А почему вы спрашиваете, молодой человек?",
                      "Нет, но я точно знаю что вы пес"]


version = "PetrosyanBotPy версия 1.0! Тот же самый бот, но на Python"


petrostickers = ['CAADAgADaQEAAklHHQABBEGA16tOb4YC',
                 'CAADAgADawEAAklHHQABeErgzhVrOsMC',
                 'CAADAgADbQEAAklHHQABRcfQMihFD5UC',
                 'CAADAgADbwEAAklHHQABF5IwC-CbIWUC',
                 'CAADAgADcQEAAklHHQABg-TAFSRKlBEC',
                 'CAADAgADcwEAAklHHQABpTTP_kmMgMYC',
                 'CAADAgADdQEAAklHHQABByV2nDznb64C',
                 'CAADAgADdwEAAklHHQABv2sq89imy44C',
...
responceslist = [
    ...
    'Ебать ты конечно шутишь',
    'Вот я вижу шутку, но в ней нет шутки']
...
quotes = [
    ...
    '"Ни один план не выживает в столкновении с врагом"© Алексей',
    '"На пары надо ездить" ©Алексей',
    'Куда мы идём? Не, я знаю куда мы идём, но куда мы идём? Мне нужна конкретика.  © Алексей',
    ''
]
